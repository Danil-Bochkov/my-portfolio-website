...
export default function About() {
    ...
    function aboutMeText() {
        return <>
            <p><span style={{color: data.baseColor}}>{firstName}{secondName} $</span> cat
                about{firstName} </p>
    ...
    function skillsText() {
        return <>
            <p><span style={{color: data.baseColor}}>{firstName}{secondName} $</span> cd skills/tools
            </p>
            <p><span style={{color: data.baseColor}}>skills/tools <span
    ...
    function courseExperience() {
        return <>
        <p><span style={{color: data.baseColor}}>{firstName}{secondName} $</span> cd
        education/resume</p>
        <p><span style={{color: data.baseColor}}>education/resume <span
                className={Style.green}>(main)</span> $</span> ls</p>
        <p style={{color: data.baseColor}}> Education</p>
        <p style={{color: data.baseColor}}> Kharkiv National University Of Radioelectronics</p>
        ...
        <p>
            <a href={myCv} download="danny-bochkov-cv">Download my CV</a>
        </p>
        </>
    }
    ...
    function miscText() {
        return <>
            <p><span style={{color: data.baseColor}}>{firstName}{secondName} $</span> cd
                hobbies/interests</p>
            <p><span style={{color: data.baseColor}}>hobbies/interests <span
                className={Style.green}>(main)</span> $</span> ls</p>
            <ul>
